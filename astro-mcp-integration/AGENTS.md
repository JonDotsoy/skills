# Astro MCP Integration — Agent Instructions

## Overview

This skill integrates an MCP server into an existing Astro project. It generates the `/mcp`
endpoint with the tools, prompts, and resources the user describes, with OAuth 2.0 Bearer
